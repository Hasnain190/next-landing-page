    ...
    >
              ...
              >
                <div className="flex flex-col gap-8  text-white">
                  ...
                  <div className="relative w-80 h-56 md:w-96 md:h-64 lg:w-[500px] lg:h-[350px] xl:w-[600px] xl:h-[420px]">
                    <Image src={item.img} alt="hero" fill />
                  </div>
      ...
      <div className="w-screen h-screen flex flex-col gap-16  items-center text-center">
        ...
        <div className="relative">
          ...
          <Link
            href="/contact"
            className="w-16 h-16 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 mx-auto my-auto  bg-black text-white rounded-full grid place-items-center"
          >
            Hire Me
          </Link>
        </div>
